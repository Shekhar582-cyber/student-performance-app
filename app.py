...
st.markdown("""
Welcome! This tool helps predict whether a student is likely to **Pass ✅** or **Fail ❌** based on their academic and personal attributes.
""")
...
if submitted:
    ...
    confidence_text = f"Confidence: {probability:.2%}"
    ...
    input_data["Confidence"] = confidence_text
...
st.markdown("Upload an Excel file containing multiple student records with the following columns:")
st.code("age, studytime, failures, absences, goout, health, sex, schoolsup")
...
if uploaded_file is not None:
    try:
        ...
        st.error("The required library `openpyxl` is not installed. Please add `openpyxl` to requirements.txt")